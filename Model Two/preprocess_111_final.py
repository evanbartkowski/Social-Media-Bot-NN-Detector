...
source_url = https://stackoverflow.com/questions/2400643/is-there-a-memory-efficient-and-fast-way-to-load-big-json-files
print(source_url)
...
with open('./processed_data/id_tweet.json', 'w') as f_out:
    json.dump(id_tweet, f_out)